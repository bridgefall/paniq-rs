...
- **Cross-language smoke checks**: `paniq-rs/tests/go_parity.rs` exercises multiple obfuscation specs against the Go helper (`go run ./cmd/obf-vector`) to validate byte-for-byte parity for deterministic chains.
